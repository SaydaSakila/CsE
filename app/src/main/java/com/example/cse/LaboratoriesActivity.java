    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button20.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent hp = new Intent(LaboratoriesActivity.this,LaboratoriesActivity.class);
                startActivity(hp);
            }
        });
        ...
        button21.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent hp = new Intent(LaboratoriesActivity.this,CareerActivity.class);
                startActivity(hp);
            }
        });
        ...
        button23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent hp = new Intent(LaboratoriesActivity.this,SocietyActivity.class);
                startActivity(hp);
            }
        });
